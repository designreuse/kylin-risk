    ...
    <div class="ibox-content   float-e-margins">
        ...
        <div class="row">
            <div class="form-group">
              ...
              <div class="col-sm-3 m-b">
                  <dict:select dictcode="category"  id="grouptype" name="grouptype"  nullLabel="请选择" nullOption="true" cssClass="form-control" onchange="changetype()" value="${group.grouptype}" required="true" ></dict:select>
              </div>
            </div>
        </div>
        <div class="row">
