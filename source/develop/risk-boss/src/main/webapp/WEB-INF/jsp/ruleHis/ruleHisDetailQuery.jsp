...
<form id="addRuleform" method="post" data-parsley-validate class="form-horizontal">
  <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
    ...
    <input type="hidden" name="groupversionid" id="groupversionid" value="${rule.groupversionid}"/>
...
<div id="siteMeshJavaScript">
  <script type="text/javascript" >
    ...
    $(function(){
      $("#back").click(function(){
        window.location.href="${ctxPath}/ruleHis/toQueryRuleHis?groupVersionId="+$("#groupversionid").val()+"&ruleids="+$("#ruleids").val()+"&restr="+$("#restr").val();
      });
    });
  </script>
</div>
