...
public class PersonBizImpl extends BaseBizImpl implements PersonBiz {
  ...
  public boolean personmsg(PersonFactor personFactor) {
    ...
    //如果是工商银行则续议,
    if (RuleConstants.KEZHAN_CONST_ID.equals(personFactor.getConstid())
    ...
    if (isNotEmpty(personFactor.getCheckorderid()) && !"null".equals(
      ...
      if (RuleConstants.YUESHIJUE_CHANNEL_ID.equals(personFactor.getConstid())
          ...
          || RuleConstants.XINGREN_CHANNEL_ID.equals(personFactor.getConstid())) {
  ...
  private OperateFlow generateOperateFlow(PersonFactor personFactor, String status,
    ...
    operateFlow.setLogourlkey(personFactor.getLogourlkey());
    operateFlow.setContracturlkey(personFactor.getContracturlkey());
    operateFlow.setPhotographytype(personFactor.getPhotographyType());
    operateFlow.setSchoolprovince(personFactor.getProvince());
    operateFlow.setSchoolcity(personFactor.getCity());
    operateFlow.setSalary(personFactor.getSalary());
    operateFlow.setUnitfulladdress(personFactor.getUnitFullAddress());
    operateFlow.setCurrentaddress(personFactor.getCurrentAddress());
    operateFlow.setCurrentfulladdress(personFactor.getCurrentFullAddress());
    operateFlow.setCheckmethod(personFactor.getCheckMethod());
    return operateFlow;
  }
  ...
  private Customerinfo generateCustomerinfo(PersonFactor personFactor) {
    ...
    customerinfo.setMatesex(personFactor.getMatesex());
    customerinfo.setMateaddress(personFactor.getMateaddress());
    customerinfo.setMatenation(personFactor.getMatenation());
    customerinfo.setMatestartdate(personFactor.getMatestartDate());
    customerinfo.setMateenddate(personFactor.getMateendDate());
    customerinfo.setMateurlkey(personFactor.getMateurlkey());
    customerinfo.setChildname(personFactor.getChildName());
    customerinfo.setChildcardid(personFactor.getChildCardId());
    return customerinfo;
  }
