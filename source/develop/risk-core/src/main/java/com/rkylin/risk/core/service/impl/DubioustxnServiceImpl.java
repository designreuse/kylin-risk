...
public class DubioustxnServiceImpl implements DubioustxnService {
    ...
    @Override
    public List<Map> exportDubiousExcel(String productall, String[] products, String productnull,
                                        String customnum, String warnstatus, DateTime beginWarnDate,
                                        DateTime endWarnDate) {
        Map map = new HashMap();
