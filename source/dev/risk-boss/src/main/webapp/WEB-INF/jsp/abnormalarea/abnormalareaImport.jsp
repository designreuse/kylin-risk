...
<div id="wrapper" >
  <div class="wrapper wrapper-content animated fadeInRight ecommerce">
    <div class="ibox-content m-b-sm border-bottom">
      <form role="form" id="fileform" method="post" data-parsley-validate action="${ctxPath}/api/1/abnormalarea/importAbnormalArea?${_csrf.parameterName}=${_csrf.token}" class="form-inline"  enctype="multipart/form-data" >
