...
<div id="wrapper" >
  <div class="wrapper wrapper-content animated fadeInRight ecommerce">
    <div class="ibox-content m-b-sm border-bottom">
      <form role="form" id="form" action="${ctxPath}/customerbwg/queryCustomebwglist"  method="get" data-table="queryTable">
        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
        <input type="hidden" id="flag" value="${flag}">
        <div class="row">
          <div class="col-sm-4">
              <label class="control-label" for="customername">客户名称</label>
              <input type="text" class="form-control input-sm" id="customername" name="customername" placeholder="用户名称" class="form-control">
          </div>
          <div class="col-sm-4">
            <label class="control-label" for="customernum">客户ID</label>
            <input type="text" class="form-control input-sm" id="customernum" name="customernum" placeholder="用户编号" class="form-control">
          </div>
          <div class="col-sm-4">
            <div class="form-group">
              <label class="control-label" for="type">名单类型</label>
              <dict:select dictcode="type" id="type" name="type"  nullLabel="请选择" nullOption="true" cssClass="form-control"></dict:select>
        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <dict:select dictcode="80004" id="cardtype" name="cardtype"  nullLabel="请选择" nullOption="true" cssClass="form-control"></dict:select>
            </div>
          </div>
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control input-sm" id="cardnum" name="cardnum"  placeholder="证件号码" class="form-control">
            </div>
          </div>
        </div>
          ...
          <c:if  test="${flag=='02'}">
            <div class="btn-group">
              ...
              <ul class="dropdown-menu">
                <li><a href="${ctxPath}/customerbwg/toQueryCusBWG?type=black" >新增黑名单</a></li>
                <li><a href="${ctxPath}/customerbwg/toQueryCusBWG?type=white" >新增白名单</a></li>
                <li><a href="${ctxPath}/customerbwg/toQueryCusBWG?type=gray"  >新增灰名单</a></li>
              </ul>
            </div>
          </c:if>
        </div>
  ...
  $(function(){
    ...
    $('form#form').queryTables({
...

      {
          targets:10,
        render:function(data, type, row, meta){
          var dataMap={'00':'有效','01':'无效','02':'新增待审核','03':'移除待审核','04':'审核拒绝'};
          return dataMap[data]||data;
        }
        }
      ]
