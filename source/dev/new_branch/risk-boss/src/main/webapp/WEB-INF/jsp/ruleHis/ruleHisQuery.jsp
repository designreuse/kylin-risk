...
<body >
<div id="wrapper" class="divContainer1">
  <div class="wrapper wrapper-content animated fadeInRight backPageDiv1">
...
<div id="siteMeshJavaScript">
  <script type="text/javascript">
    ...
    function getRuleHisDetail(id){
      $.ajaxParamBack({"url":"${ctxPath}/ruleHis/toAjaxQueryRuleHisDetail","data":"id="+id,"divContainer":"divContainer1","backPageClsName":"backPageDiv1"});
    ...
    function queryGrouVersionTable(){
      ...
      $('table#tabId').DataTable({
        "ajax":"${ctxPath}/api/1/ruleHis/queryRuleHis?queryId="+$("#queryId").val()+"&queryType="+$("#queryType").val(),
        "paging": false,
        "deferRender": true,
        "info":false,
        columns: [
        ...
        columnDefs:[
          ...
          },
          {
            ...
            render: function (data, type, row, meta) {
              ...
              {
                func: [
                  {"text": "查看", "fn": "getRuleHisDetail("+row.id+")", "cssClass": "fa-wrench"},
                 ]
              };
