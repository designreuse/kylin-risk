...
<div id="wrapper" >
  <div class="wrapper wrapper-content animated fadeInRight ecommerce">
    ...
    <div class="ibox-content m-b-sm border-bottom">
      <form role="form" id="form" action="${ctxPath}/customer/queryCusByCondition"  method="get" data-table="queryTable">
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <label>开户日期开始</label>
            <input type="text" id="timebegin" name="timebegin" onClick="WdatePicker()" class="form-control">
          </div>
          <div class="col-md-2">
            <label>开户日期结束</label>
            <input type="text" id="timeend" name="timeend"  onClick="WdatePicker()" class="form-control">
          </div>
        </div>
        <div align="center">
