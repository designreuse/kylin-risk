      ...
      for (OperateFlow operateFlow : operateFlowsList) {
        ...
        try {
          ...
          if (response != null && response.getFlag() == 0 && response.getData() != null) {
            ...
            if (ApiMitouConstants.ACCEPT.equals(response.getData().getMainStatus())
                || ApiMitouConstants.REFUSE.equals(response.getData().getMainStatus())
