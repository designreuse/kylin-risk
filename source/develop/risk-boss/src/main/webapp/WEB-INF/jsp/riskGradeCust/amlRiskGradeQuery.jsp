...
<div id="siteMeshJavaScript">
  <script type="text/javascript">
              ...
              success : function(data, textStatus, jqXHR) {
                if(data.code==200){
                  bootbox.alert("设置成功！", function() {
                    window.location.href="${ctxPath}/amlGradeCust/toQueryAmlRiskGradeCust?_initQuery=true";
                  });
                }else{
    ...
    function getDetail(id,type) {
      window.location.href="${ctxPath}/amlGradeCust/getAmlRiskGradeDetail?id="+id+"&operType="+$("#operType").val();
    }
