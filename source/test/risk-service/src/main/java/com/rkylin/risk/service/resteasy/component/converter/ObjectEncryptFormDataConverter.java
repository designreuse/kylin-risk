...
public class ObjectEncryptFormDataConverter<T> extends AbstractEncryptFormDataConverter<T> {
  ...
  public ObjectEncryptFormDataConverter(PublicKey publicKey, ObjectMapper objectMapper,Class classType,boolean isEncoded) {
    super(publicKey,classType,isEncoded);
