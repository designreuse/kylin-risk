                    ...
                    <tr>
                      ...
                      <td>
                        <dict:select dictcode="status" id="status" name="status"
                                     ...
                                     required="true" value="${role.status}"></dict:select>
                      </td>
                    </tr>
                  </table>
                </div>
  ...
  <script type="text/javascript" >
   ...
   function setChecked(obj,levtype,num,index) {
     ...
     if("firLev"==levtype){//操作一级菜单
       ...
       if(obj.checked==true) {
         $("form input[levFlag^="+secLev+"_]").attr("checked", true);
         $("form input[levFlag^="+threeLev+"_]").attr("checked", true);

       }else {
         $("form input[levFlag^=" + secLev + "_]").attr("checked", false);
         $("form input[levFlag^=" + threeLev + "_]").attr("checked", false);
       }
     }
   }
