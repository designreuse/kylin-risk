    ...
    <div class="ibox-content m-b-sm border-bottom">
      <form role="warnsetform" id="warnsetform" action="${ctxPath}/warningset/queryWarningset" method="get" data-table="queryTable">
        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
          <div align="left" >
            <a href="${ctxPath}/warningset/toAddWarnSet">
...
<div id="siteMeshJavaScript">
  <script type="text/javascript">
            ...
            $.ajax( {
              ...
              success : function(data, textStatus, jqXHR) {
                if(textStatus=="success"){
                  bootbox.alert("删除成功！");
                  window.location.href="${ctxPath}/warningset/toQueryWarningSet";
                }else{
                  bootbox.alert("删除失败！");
                  window.location.href="${ctxPath}/warningset/toQueryWarningSet";
                }
   ...
   //删除结束
    ...
    function modify(id){
      window.location.href="${ctxPath}/warningset/towarningsetModify?wsId="+id;
    }
