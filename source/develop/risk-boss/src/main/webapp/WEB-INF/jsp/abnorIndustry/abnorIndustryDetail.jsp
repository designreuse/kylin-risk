...
<div id="siteMeshJavaScript">
  <script type="text/javascript" >
    $(function(){
      $("#back").click(function(){
        window.location.href="${ctxPath}/abnorIndustry/toQueryAbnorIndustry.action?_initQuery=true&codenm=${abnorIndustrys.codenm}&codeid=${abnorIndustrys.codeid}";
      });
    });
    $(function(){
          ...
          success: function(data,textStatus,jqXHR){
            if(data.code==200){
              bootbox.alert("修改成功！", function () {
                window.location.href="${ctxPath}/abnorIndustry/toQueryAbnorIndustry";
              });
            }else{
