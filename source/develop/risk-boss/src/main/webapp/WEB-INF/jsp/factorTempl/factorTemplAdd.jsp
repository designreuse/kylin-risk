    ...
    <div class="ibox-content   float-e-margins">
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-sm-3 m-b">
                    <select name="libraryid" id="factorLibrary" class="form-control" multiple=""></select>
                </div>
            </div>
        </div>
...
<div id="siteMeshJavaScript">
  <script type="text/javascript" >
      ...
      $(function(){
          ...
          $("#back").click(function(){
              window.location.href="${ctxPath}/factorTempl/toQueryFactorTempl";
          });
      ...
      function addFactorLibrary(factorSelect,factortype){
          factorSelect.empty();
          $.getJSON("${ctxPath}/api/1/factorLibrary/queryFactorByType?type="+factortype,function(json){
              $.each(json.data, function(index,factors){
                  factorSelect.append('<option value="' + factors['id'] + '">' + factors['name'] + '</option>');
              });

          });
      }
      function subRuleAdd(){
          var initparsley=$("#addFactorTemplform").parsley();
