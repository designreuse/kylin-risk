(function(c) {
    ...
    c.fn.editableSelect = function(a) {
        ...
        this.replaceWith(d,z); ({
            init: function() {
                var f = this;
                f.copyAttributes(g, d);
                d.addClass("es-input");
                d.attr("name","");
                z.attr("name",g.attr("name"));
                c(document.body).append(b);
                var l = c(d).attr("value");
                d.val(l);
                z.val(l);
                g.find("option").each(function() {
                    ...
                    b.append(a);
                    if(l==c(this).attr("myvalue")){
                        d.val(c(this).text());
                    }
                });
                d.on("focus input click", f.show);
                z.on("focus input click", f.show);
