...
public class DubioustxnAction {
    ...
    public ModelAndView toQueryDubioustxn() {
        return new ModelAndView("dubioustxn/dubioustxnQuery");
    }

    @RequestMapping("toQueryDubioustxnCondition")
    public ModelAndView toQueryDubioustxnCondition() {
        return new ModelAndView("dubioustxn/dubioustxnQueryCondition");
    }
    ...
    public void exportDubioustxnExcel(HttpServletResponse response, String productall,
        ...
        LocalDate beginWarnDate = StringUtils.isEmpty(warndates) ? null
                : LocalDate.parse(warndates, dtFormat);
        LocalDate endWarnDate = StringUtils.isEmpty(warndatee) ? null
                : LocalDate.parse(warndatee, dtFormat);
        ...
        List<DubiousExportBean> listdubioustxn = new ArrayList<>();
        ...
        ExportExcel<DubiousExportBean> export = new ExportExcel<>();
        try {
