...
public class AmlDubioustxnReportAction {
  ...
  public void exportExcel(HttpServletRequest req, HttpServletResponse resp,
    ...
    List<AmlDubiousTxnExportBean> dataset = new ArrayList<AmlDubiousTxnExportBean>();
    ExportExcel<AmlDubiousTxnExportBean> ex = new ExportExcel<AmlDubiousTxnExportBean>();
