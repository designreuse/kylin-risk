...
public class OrderServiceImpl implements OrderService {
  ...
  @Override
  public Order queryByCheckorderid(String checkorderid) {
    Map map = Maps.newHashMap();
    map.put("checkorderid", checkorderid);
    return orderDao.queryByCheckorderid(map);
  }
  ...
  @Override public void updateStatusid(List<Order> orders) {
    orderDao.updateStatusid(orders);
  }

  @Override public List<Order> queryByIdenAndStatus(String identityCard, String[] status) {
    return orderDao.queryByIdenAndStatus(identityCard, status);
  }
}
