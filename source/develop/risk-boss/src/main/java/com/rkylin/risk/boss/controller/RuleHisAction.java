...
public class RuleHisAction {
  ...
  @RequestMapping("toQueryRuleHis")
  public ModelAndView toQueryRuleHis(@RequestParam String restr, String groupVersionId,
      String ruleids
  ) {
    ModelAndView view = new ModelAndView("ruleHis/ruleHisQuery");
    view.addObject("groupVersionId", groupVersionId);
    view.addObject("ruleids", ruleids);
    view.addObject("restr", restr);
    return view;
  }

  @RequestMapping("toQueryRuleHisDetail")
  public ModelAndView toQueryRuleHisDetail(@RequestParam String id, String ruleids, String restr) {
