...
<div id="wrapper">
  <div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="row query-div">
      <a href="toAddFactorLibrary">
        <button type="button" id="toAddFactorLibrary" class="btn btn-w-m btn-primary">添加</button>
      </a>
...
<div id="siteMeshJavaScript">
  <script type="text/javascript">
    ...
    function getDetail(id){
      window.location.href="${ctxPath}/factorLibrary/queryFactorLibraryDetail?id="+id;
    }
