...
public class CourseDaoImpl extends BaseDaoImpl<Course> implements CourseDao {
    ...
    public List<Course> queryByUserrelatedid(String userrelatedid) {
        return super.selectList("queryByUserrelatedid", userrelatedid);
    }

    @Override
    public List<String> queryCourseNameByUserrelatedid(String userrelatedid) {
        return super.selectList("queryCourseNameByUserrelatedid", userrelatedid);
    }

    @Override
    public List<Course> queryCourseByCondition(Course course) {
        return super.selectList("queryCourse", course);
    }
    ...
    public Course queryByMerchantidAndCourseName(String merchantid, String coursename) {
        ...
        return super.selectOne("queryByMerchantidAndCourseName", map);
    }
    ...
    @Override public void deleteByMerchantid(String merchantid) {
        super.del("deleteByMerchantid",merchantid);
    }
}
