                ...
                <div class="wrapper wrapper-content animated fadeInRight ecommerce">
                    <div class="ibox-content m-b-sm border-bottom">
                        ...
                        <div class="row query-div">
                            <a href="toAjaxAddFunction" class="ajaxback-requst">
...
<div id="siteMeshJavaScript">
    <script type="text/javascript">
        ...
        function getDetail(id,type) {
            ...
            $.ajaxParamBack({"url":"${ctxPath}/function/toAjaxGetFunctionDetail","data":"ids="+id+"&dealType="+type+"&functionname="+functionname+"&functiontype="+functiontype+"&url="+url+"&status="+status});
        }
