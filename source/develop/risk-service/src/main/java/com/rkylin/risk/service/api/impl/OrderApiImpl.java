...
public class OrderApiImpl implements OrderApi {
  ...
  public ResultInfo ordercheck(SimpleOrder simpleOrder, String hmac) {
    ...
    if (isEmpty(simpleOrder.getOrderId()) || isEmpty(simpleOrder.getOrderTypeId())
        || isEmpty(simpleOrder.getRootInstCd()) || isEmpty(simpleOrder.getProductId())
        || isEmpty(simpleOrder.getUserId())) {
