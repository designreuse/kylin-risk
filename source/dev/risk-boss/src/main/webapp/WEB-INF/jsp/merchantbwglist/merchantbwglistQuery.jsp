        ...
        <div align="center" style="margin-top: 20px">
          ...
          <div class="btn-group">
            ...
            <ul class="dropdown-menu">
              <li><a href="${ctxPath}/mercbwg/toAjaxQueryMerBWG?type=black"  class="font-bold ajaxback-requst">新增黑名单</a></li>
              <li><a href="${ctxPath}/mercbwg/toAjaxQueryMerBWG?type=white" class="font-bold ajaxback-requst">新增白名单</a></li>
              <li><a href="${ctxPath}/mercbwg/toAjaxQueryMerBWG?type=gray" class="font-bold ajaxback-requst">新增灰名单</a></li>
            </ul>
          </div>
            </c:if>
        </div>
