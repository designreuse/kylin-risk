    ...
    <div class="ibox-content   float-e-margins">
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-sm-3 m-b">
                    <input type="text" name="effdate"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="form-control Wdate" id="effdate"  required />
                </div>
            </div>
        </div>
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-sm-3 m-b">
                    <input type="text" name="expdate"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="form-control Wdate" id="expdate"  required />
                </div>
            </div>
        </div>
        <div class="row">
                                ...
                                <div class="faq-answer">
                                    <table>
                                        ...
                                        <c:forEach items="${channel.dictionaryCodes}" var="dic" varStatus="i">
                                            ...
                                            <td>
                                                <input type="checkbox" name="channels[${all.index}].mercCode" value="${dic.code}"  thirdFlag="${channel.dictionaryCode.code}">${dic.name}
                                            </td>
                                            <c:if test="${i.count%8==0}">
                                                </tr>
                                            </c:if>
  ...
  <script type="text/javascript" >
      ...
      $(function(){
          $("#submitAdd").click(function(){
              ...
              }else if(!validateRuleType()){
                  bootbox.alert("请选择规则类型！");
              }else{
                  subRuleAdd();
              }
          });
      ...
      function subRuleAdd(){
          var initparsley=$("#addGroupform").parsley();
