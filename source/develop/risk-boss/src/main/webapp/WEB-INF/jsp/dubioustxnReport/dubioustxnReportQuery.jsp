            ...
            <div class="ibox-content m-b-sm border-bottom">
              <form  role="form" id="billform" action="${ctxPath}/dubioustxnReport/queryDubioustxnReport" method="get" data-table="queryTable">
                ...
                <div class="row">
                  <div class="col-md-3">
                    <label>交易日期开始</label>
                    <input type="text" id="timebegin" name="timebegin" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})" class="form-control Wdate">
                  </div>
                  <div class="col-md-3">
                    <label>交易日期开始</label>
                    <input type="text" id="timeend" name="timeend"  onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})" class="form-control Wdate">
                  </div>
                </div>
                <div align="center">
