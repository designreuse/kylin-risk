...
public class MulThreadRSAUtils {
  ...
  public static String decryptMitouData(String encryptedData, String publicKey) {
    String decodedata = "";
    try {
      byte[] keyBytes = DatatypeConverter.parseBase64Binary(publicKey);
      X509EncodedKeySpec x509KeySpec = new X509EncodedKeySpec(keyBytes);
      ...
      decodedata = new String(DatatypeConverter.parseBase64Binary(sw.toString()));
    } catch (Exception e) {
      e.printStackTrace();
    }
    return decodedata;
