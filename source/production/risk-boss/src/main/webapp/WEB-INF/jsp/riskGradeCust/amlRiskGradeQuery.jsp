...
<div id="wrapper" class="divContainer">
  <div class="wrapper wrapper-content animated fadeInRight ecommerce backPageDiv">
    <div class="ibox-content m-b-sm border-bottom">
      <form role="riskGradeForm" id="riskGradeForm" action="${ctxPath}/amlGradeCust/queryAmlGradeCust" method="get" data-table="queryTable" >
...
<div id="siteMeshJavaScript">
  <script type="text/javascript">
        ...
        bootbox.prompt("请输入更改评级等级原因", function(result) {
          if(result==null){
            ...
            $.ajax( {
              ...
              url: "${ctxPath}/api/1/amlGradeCust/updateAmlGrade",
    ...
    function checkRiskGrade(status){
      ...
      if (chooseGrade.length == 0) {
        ...
        $.ajax( {
          ...
          url: "${ctxPath}/api/1/amlGradeCust/updateAmlGradeStatus",
    ...
    function getDetail(id,type) {
      $.ajaxParamBack({"url":"${ctxPath}/amlGradeCust/toAjaxGetAmlRiskGradeDetail","data":"id="+id+"&operType="+$("#operType").val()});
    }
