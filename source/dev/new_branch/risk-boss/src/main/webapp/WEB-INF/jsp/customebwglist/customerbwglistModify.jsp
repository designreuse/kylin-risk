          ...
          <div class="ibox float-e-margins">
            <div class="ibox-content">
              <form id="updatForm" method="post"  class="form-inline" data-parsley-validate>
                ...
                <input type="hidden" name="id" value="${customebwglist.id}">
                <input type="hidden" name="opertype" value="time">
                <div class="row">
                  <div class="col-sm-6">
                    <label class="control-label" for="effecttime">生效时间</label>
                    <input type="text" onClick="WdatePicker()" class="form-control input-sm" id="effecttime"  value="${customebwglist.effecttime}" name="effecttime" class="form-control" required>
                  </div>
                  <div class="col-sm-6">
                    <label class="control-label" for="failuretime">失效时间</label>
                    <input type="text"  onClick="WdatePicker()"  class="form-control input-sm" id="failuretime" name="failuretime" value="${customebwglist.failuretime}" class="form-control" required>
                  </div>
                  </div>
