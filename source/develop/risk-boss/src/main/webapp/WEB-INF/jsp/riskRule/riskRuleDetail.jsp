...
<div id="siteMeshJavaScript">
  <script type="text/javascript" >
    $(function(){
      $("#back").click(function(){
        window.location.href="${ctxPath}/riskrule/toQueryRiskrule.action?_initQuery=true&rulename=${riskrules.rulename}&status=${riskrules.status}&risktype=${riskrules.risktype}";
      });
    });
    $(function(){
