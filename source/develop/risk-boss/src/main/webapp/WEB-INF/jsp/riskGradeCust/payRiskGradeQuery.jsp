...
<div id="siteMeshJavaScript">
  <script type="text/javascript">
              ...
              success : function(data, textStatus, jqXHR) {
                if(data.code==200){
                  bootbox.alert("设置成功！", function() {
                    window.location.href="${ctxPath}/riskGradeCust/toQueryPayRiskGradeCust?_initQuery=true";
                  });
                }else{
                  bootbox.alert("设置失败！");
                }
    ...
    function getDetail(id,type) {
      window.location.href="${ctxPath}/riskGradeCust/getPayRiskGradeDetail?id="+id+"&operType="+$("#operType").val();
    }
