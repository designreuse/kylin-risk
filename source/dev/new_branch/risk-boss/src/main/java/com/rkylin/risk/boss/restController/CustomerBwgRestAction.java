...
public class CustomerBwgRestAction {
  ...
  public String customerbwgModify(String ids, String opertype, String reason,
    ...
    operatorLogService.insert(auth.getUserId(), auth.getUsername(), "CustomebwgList", "更新");
    return custIds;
  }
  ...
  public CustomebwgList addBWG(@ModelAttribute CustomebwgList bwg, String addIds,
    ...
    operatorLogService.insert(auth.getUserId(), auth.getUsername(), "CustomebwgList", "添加");
    return bwg;
  }
  ...
  public String delBwg(String deleteIds, HttpServletRequest request, String reason) {
    ...
    operatorLogService.insert(auth.getUserId(), auth.getUsername(), "CustomebwgList", "删除");
    return deleteIds;
  }
  ...
  public String verifyBwg(@ModelAttribute CustomebwgList bwg, String ids,
    ...
    operatorLogService.insert(auth.getUserId(), auth.getUsername(), "CustomebwgList", "修改");
    return custIds;
  }
}
