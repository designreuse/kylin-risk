...
<div id="wrapper" >
  <div class="wrapper wrapper-content animated fadeInRight ecommerce">
    <div class="ibox-content m-b-sm border-bottom">
      <form role="form" id="fileform" method="post" data-parsley-validate action="${ctxPath}/api/1/abnorCountry/importAbnorCountry?${_csrf.parameterName}=${_csrf.token}" class="form-inline"  enctype="multipart/form-data" >
          ...
          success: function(data,textStatus,jqXHR){
            if(data.code==200){
              bootbox.alert("上传成功！", function () {
                $('#myModal').modal('hide');
                window.location.href="${ctxPath}/abnorCountry/toQueryAbnorCountry.action?_initQuery=true";
              });
            }else{
