      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control input-sm Wdate" name="createtimebeg" id="createtimebeg" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'createtimeend\')||\'new Date()\'}'})" >
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            <label class="control-label">生成时间(截止)</label>
            <input type="text" class="form-control input-sm Wdate" name="createtimeend" id="createtimeend" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'createtimebeg\')}',maxDate:'#F{\'new Date()\'}'})" >
          </div>
        </div>
      </div>
...
<div id="siteMeshJavaScript">
  <script type="text/javascript">
    ...
    function getDetail(id,casetype) {
      $.ajaxParamBack({"url":"${ctxPath}/case/toAjaxGetCaseDetail","data":"id="+id+"&casetype="+casetype});
    }
