    ...
    <div class="ibox-content   float-e-margins">
        ...
        <div class="row">
            <div class="form-group">
              ...
              <div class="col-sm-3 m-b">
                  <dict:select dictcode="category"  id="grouptype" name="grouptype"  nullLabel="请选择" nullOption="true" cssClass="form-control" value="${group.grouptype}" required="true" ></dict:select>
              </div>
            </div>
        </div>
        <div class="row">
            <div class="form-group">
              ...
              <div class="col-sm-3 m-b">
                  <dict:select dictcode="servicetype"  id="servicetype" name="servicetype"  nullLabel="请选择" nullOption="true" cssClass="form-control"  value="${group.servicetype}" required="true" ></dict:select>
              </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <dict:select dictcode="status" id="status" name="status" escapeValue="02,03,99,04,05" nullLabel="请选择" nullOption="true" cssClass="form-control"  value="${group.status}" required="true" ></dict:select>
                </div>
            </div>
        </div>
...
<div id="siteMeshJavaScript">
  <script type="text/javascript" >
      ...
      function subRuleAdd(){
          var valid = $("#modifyGroupform").parsley().validate();
