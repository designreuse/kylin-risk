...
<div id="wrapper" class="divContainer">
  <div class="wrapper wrapper-content animated fadeInRight backPageDiv" >
    <div class="ibox-content m-b-sm border-bottom">
      <form id="unionPayAdvisorsForm" action="" data-parsley-validate data-table="queryTable">
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" id="name" name="name" placeholder="申请人姓名" class="form-control" required>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" id="userId" name="userId"  placeholder="用户ID" class="form-control" required>
              </div>
            </div>
          </div>
        </div>
  ...
  <script type="text/javascript">
    ...
    $(function () {
      ...
      $("#submitQuery").click(function () {
        $('#tableList').html('');
        var initparsley = $("#unionPayAdvisorsForm").parsley();
        if(initparsley.validate()){
            ...
            if(!reg.test(bankCard)) {
              ...
              $("#unionPayAdvisorsForm").ajaxSubmit({
                type: "POST",
      ...
      //判断风险得分分类
      Handlebars.registerHelper("channel",function(value){
        if(value='M000025'){
          return "悦视觉";
