...
public final class RedisConfigurationBuilder {
  ...
  private static final String SYSTEM_PROPERTY_REDIS_PROPERTIES_FILENAME =
      "redis.properties.filename";
  ...
  public RedisConfig parseConfiguration(ClassLoader classLoader) {
    ...
    if (input != null) {
      ...
      throw new RuntimeException("not find jedis properties file");
    }
