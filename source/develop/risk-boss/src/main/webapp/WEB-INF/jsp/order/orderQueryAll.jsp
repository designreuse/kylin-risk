        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <input type="text" id="ordertimes" name="ordertimes" placeholder="开始交易日期" class="form-control input-sm Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
            </div>
          </div>
          <div class="col-sm-4">
          <div class="form-group">
            <label class="control-label" for="ordertimee">截止交易日期</label>
            <input type="text" id="ordertimee" name="ordertimee" placeholder="截止交易日期" class="form-control input-sm Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
          </div>
        </div>
        </div>
