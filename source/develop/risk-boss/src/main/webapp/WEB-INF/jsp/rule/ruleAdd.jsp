    ...
    <div class="ibox-content   float-e-margins">
        ...
        <c:if test="${rolename=='SUPERMODIFIER'}">
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-sm-3 m-b">
                        <dict:select dictcode="ruleclass" id="ruleclass" name="ruleclass"   cssClass="form-control" ></dict:select>
                    </div>
                </div>
            </div>
        </c:if>
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-sm-3 tooltip-demo">
                    <input class="form-control" name="priority" id="priority" required number data-toggle="tooltip" data-placement="right" title="仅支持数字，数值越大优先级越高"/>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-sm-3 tooltip-demo">
                    <select class="form-control" id="result" name="result" data-toggle="tooltip" data-placement="right" title="评分规则仅支持数字和“禁入”，逻辑规则支持自定义和“禁入”">
                        <option></option>
