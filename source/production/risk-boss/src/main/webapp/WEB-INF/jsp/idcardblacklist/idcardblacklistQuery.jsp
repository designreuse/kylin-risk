      ...
      <form role="form" id="form" action="${ctxPath}/idcardblack/queryIdCardBlackList"  method="get" data-table="queryTable">
        ...
        <div class="row">
          <div class="col-sm-4">
            ...
            <input type="text" class="form-control input-sm" id="name" name="name" placeholder="姓名" class="form-control">
          </div>
          <div class="col-sm-4">
            <label class="control-label" for="identnum">身份证号码</label>
            <input type="text" class="form-control input-sm" id="identnum" name="identnum" placeholder="身份证号码" class="form-control">
          </div>
          <div class="col-sm-4">
