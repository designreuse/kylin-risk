...
public class FactorLibraryAction {
  ...
  @RequestMapping("toAjaxAddFactorLibrary") ModelAndView toAddFactorLibrary() {
    return new ModelAndView("factorLibrary/factorLibraryAdd");
  }

  @RequestMapping("toAjaxQueryFactorLibraryDetail") ModelAndView queryFactorLibraryDetail(
