        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <input type="text" id="warndates" name="warndates" placeholder="开始预警日期" class="form-control input-sm Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
            </div>
          </div>
          <div class="col-sm-4">
          <div class="form-group">
            <label class="control-label" for="warndatee">截止预警日期</label>
            <input type="text" id="warndatee" name="warndatee" placeholder="截止预警日期" class="form-control input-sm Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
          </div>
        </div>
        </div>
...
<div id="siteMeshJavaScript">
  <script type="text/javascript">
    ...
    function queryRule(ruleids,restr){
      window.location.href="${ctxPath}/ruleHis/toQueryRuleHis?ruleids="+ruleids+"&restr="+restr;
    }
    //绑定form的查询到tables
    $(function(){
        ...
        columnDefs:[
          ...
          },
          {
            ...
            render:function(data, type, row, meta){
              ...
              {
                func: [
                  {"text": "查看",  "fn":"queryRule('"+data+"','dubioustxn/toQueryDubioustxnCondition')"}
                ]
              };
