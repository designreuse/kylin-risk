...
<div id="siteMeshJavaScript">
  <script type="text/javascript">
        ...
        "columns": [
          ...
          },
          {
            ...
            render:function(data, type, row, meta){
              ...
              {
                func: [
                  {"text": "查看",  "fn":"queryRule('"+data+"','dubioustxn/toQueryDubioustxn')"}
                ]
              };
    ...
    function getDetail(customerid,dubioustxnid){
      window.location.href="${ctxPath}/dubioustxn/customerDetail?ids="+customerid+"&simpleBillId="+dubioustxnid;
    }
