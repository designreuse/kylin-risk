		...
		<div class="ibox-content m-b-sm border-bottom">
			<form role="ruleForm" id="ruleForm" action="${ctxPath}/riskrule/queryRiskrule" method="get" data-table="queryTable" >
				...
				<div class="row query-div">
					<a href="toAjaxAddRiskrule" class="ajaxback-requst">
...
<div id="siteMeshJavaScript">
	<script type="text/javascript">
		...
		function getDetail(id,type) {
			...
			$.ajaxParamBack({"url":"${ctxPath}/riskrule/toAjaxGetRiskruleDetail","data":"ids="+id+"&dealType="+type+"&rulename="+rulename+"&status="+status+"&category="+category});
		}
