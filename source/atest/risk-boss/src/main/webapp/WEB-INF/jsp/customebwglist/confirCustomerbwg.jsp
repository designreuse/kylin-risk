                ...
                <div class="ibox-content">
                    <form id="addBwgForm" method="post" data-parsley-validate class="form-inline">
                        ...
                        <div align="center">
                            <table>
                                <tr style=" height:50px;">
                                    ...
                                    <td>
                                        <input id="datebegin" placeholder="请选择生效日期(可为空)" type="text"
                                               name="effecttime"
                                               onClick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{\'new Date()\'}',maxDate:'#F{$dp.$D(\'dateend\')}'})"
                                               class="form-control Wdate" required/>
                                    </td>
                                    <th><label>失效日期:</label></th>
                                    <td>
                                        <input id="dateend" placeholder="请选择失效日期(可为空)" type="text"
                                               name="failuretime"
                                               onClick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'datebegin\')||\'new Date()\'}'})"
                                               class="form-control Wdate" required/>
                                    </td>
                                </tr>
                        ...
                        <div class="modal-footer" style="border-top:0px solid">
                            ...
                            <button type="button" id="submitButton" class="btn btn-primary">确认添加
                            </button>
                        </div>
                    </form>
                </div>
