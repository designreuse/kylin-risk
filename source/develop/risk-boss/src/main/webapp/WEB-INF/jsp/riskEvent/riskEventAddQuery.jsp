  ...
  <script type="text/javascript">
    ...
    $(function () {
      $("#add").click(function () {
        ...
        $("#toAdd").attr("href","${ctxPath}/riskEvent/toAddRiskEvent?billIds=" + addIds+"&cusid="+cusid+"&cusnum="+cusnum);
      });
    });
        ...
        columnDefs:[
          {
            ...
            render:function(data, type, row, meta){
              return checkBoxTemplate({id:data,cusid:row.customer&&row.customer.id,cusnum:row.userid});
            }
          },
          {
            targets:2,
            render:function(data, type, row, meta){
              return data&data.customername;
            }
          }
          /*{
            targets:6,
