...
<div id="siteMeshJavaScript">
  <script type="text/javascript" >
    $(function(){
      $("#back").click(function(){
        window.location.href="${ctxPath}/abnorCountry/toQueryAbnorCountry.action?_initQuery=true&cnnm=${abnormalCountrycodes.cnnm}&cnabb=${abnormalCountrycodes.cnabb}&ennm=${abnormalCountrycodes.ennm}&enabb=${abnormalCountrycodes.enabb}&twoletter=${abnormalCountrycodes.twoletter}&threelteeer=${abnormalCountrycodes.threelteeer}&threenum=${abnormalCountrycodes.threenum}";
      });
    });
    $(function(){
          ...
          success: function(data,textStatus,jqXHR){
            if(data.code==200){
              bootbox.alert("修改成功！", function () {
                window.location.href="${ctxPath}/abnorCountry/toQueryAbnorCountry";
              });
            }else{
