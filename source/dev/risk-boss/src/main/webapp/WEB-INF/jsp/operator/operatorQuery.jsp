		...
		<div class="ibox-content m-b-sm border-bottom">
			<form role="operform" id="operform" action="${ctxPath}/operator/queryOperator" method="post" data-table="queryTable" >
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="form-group">
							<label class="control-label" for="product">产品</label>
				...
				<div align="center">
					...
					<a href="toAjaxAddOperator" class="ajaxback-requst">
...
<div id="siteMeshJavaScript">
	<script type="text/javascript">
		...
		function convertProduct(incode){
			return incode&&allProducts[incode];
		}
		...
		function modify(id) {
			$.ajaxParamBack({"url":"${ctxPath}/operator/toAjaxOperatorDetail","data":"operid="+id});
		}
