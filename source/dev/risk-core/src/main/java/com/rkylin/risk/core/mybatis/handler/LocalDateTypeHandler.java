...
public class LocalDateTypeHandler extends BaseTypeHandler<LocalDate> {
  ...
  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, LocalDate localDate,
      JdbcType jdbcType) throws SQLException {
    Date date = null;
    if (localDate != null) {
      date = new Date(localDate.toDateTimeAtStartOfDay().toDate().getTime());
    }
    ps.setDate(i, date);
  }
}
