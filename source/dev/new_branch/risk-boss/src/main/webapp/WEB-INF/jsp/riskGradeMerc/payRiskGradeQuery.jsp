          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control input-sm" id="merchantid" name="merchantid"
                     value="${merchantid}" placeholder="企业号" class="form-control">
            </div>
          </div>
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control input-sm" id="merchantname" name="merchantname"
                     value="${merchantname}" placeholder="企业名称" class="form-control">
            </div>
          </div>
        </div>
        <div class="row">
...
<div id="siteMeshJavaScript">
  <script type="text/javascript">
    ...
    function getDetail(id,type) {
      $.ajaxParamBack({"url":"${ctxPath}/riskGradeMerc/toAjaxGetMercPayRiskGradeDetail","data":"id="+id+"&operType="+$("#operType").val()});
    }
